...
import type4Front from '../../assets/type4-front.png';
import type5Front from '../../assets/type5-front.png';
...
import type4Back from '../../assets/type4-back.png';
import type5Back from '../../assets/type5-back.png';
            ...
            axios
                ...
                .then((response) => {
                    ...
                    if (response.data.userno) {
                        ...
                        axios
                            .get(
                                `${apiUrl}/api/profile?userno=${response.data.userno}`,
                            )
                            .then((res) => {
                    ...
                    if (response.data.userno2) {
                        ...
                        axios
                            .get(
                                `${apiUrl}/api/profile?userno=${response.data.userno2}`,
                            )
                            .then((res) => {
                    ...
                    {cardInfo ? (
                        <>
                            ...
                            >
                                ...
                                >
                                    유효 기간:{' '}
                                    {formatDateTimeCard(cardInfo.date)}
                                </Typography>
                            </Card>
                        </>
                    ) : (
                    ...
                    >
                        ...
                        <Box sx={{ textAlign: 'center' }}>
                            <Box
                                ...
                                onClick={() =>
                                    handleIconClick('/paymentRecords')
                                }
                            />
                            <Typography
                                sx={{
                        ...
                        <Box sx={{ textAlign: 'center' }}>
                            <Box
                                ...
                                onClick={() =>
                                    handleIconClick('/paymentRecordSummary')
                                }
                            />
                            <Typography
                                sx={{
